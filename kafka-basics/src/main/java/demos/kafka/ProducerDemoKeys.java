...
//    we'll observe the behavior that same key goes to the same partition,key is going to be an ID we define
//    and then the data with the same key will always go to the same partition.
